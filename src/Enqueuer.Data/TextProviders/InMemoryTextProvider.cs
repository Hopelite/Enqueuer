...
public class InMemoryTextProvider : IMessageProvider
{
    public string GetMessage(string key, params object[] args)
    {
        var formatText = key switch
        {
            ...
            MessageKeys.QueueMessageHandler.QueueCommand_PublicChat_QueueDoesNotExist_Message => "This chat has no queue with name '<b>{QueueName}</b>'.",
            MessageKeys.QueueMessageHandler.QueueCommand_PublicChat_QueueEmpty_Message => "Queue '<b>{QueueName}</b>' has no participants.",
            MessageKeys.QueueMessageHandler.QueueCommand_PublicChat_ListQueueParticipants_Message => "'<b>{QueueName}</b>' has these participants:\n",
            MessageKeys.QueueMessageHandler.QueueCommand_PublicChat_DisplayQueueParticipant_Message => "{Position}) <b>{UserName}</b>",
            ...
            MessageKeys.QueueMessageHandler.QueueCommand_PublicChat_DisplayQueue_Message => "• {QueueName}",
            ...
            MessageKeys.EnqueueMessageHandler.EnqueueCommand_PublicChat_QueueDoesNotExist_Message => "There is no queue with name '<b>{QueueName}</b>'. You can get list of chat queues using '<b>/queue</b>' command.",
            MessageKeys.EnqueueMessageHandler.EnqueueCommand_PublicChat_UserAlreadyParticipates_Message => "You're already participating in queue '<b>{QueueName}</b>'.",
            MessageKeys.EnqueueMessageHandler.EnqueueCommand_PublicChat_PositionSpecified_DynamicQueue_Message => "Queue '<b>{QueueName}</b>' is dynamic - you can enqueue yourself only at the end of queue.",
            MessageKeys.EnqueueMessageHandler.EnqueueCommand_PublicChat_PositionIsReserved_Message => "Position '<b>{Position}</b>' in queue '<b>{QueueName}</b>' is reserved. Please, reserve other position.",
            MessageKeys.EnqueueMessageHandler.EnqueueCommand_PublicChat_SuccessfullyAddedOnPosition_Message => "Successfully added to queue '<b>{QueueName}</b>' on position <b>{UserPosition}</b>!",
            ...
            MessageKeys.RemoveQueueMessageHandler.RemoveQueueCommand_PublicChat_UserHasNoRightToDelete_Message => "Unable to delete queue '<b>{QueueName}</b>'. It can be deleted only by it's creator or chat administrators.",
            MessageKeys.RemoveQueueMessageHandler.RemoveQueueCommand_PublicChat_SuccessfullyRemovedQueue_Message => "Successfully deleted queue '<b>{QueueName}</b>'!",

            MessageKeys.UnsupportedCommand_Message => "Bot does not support the '{Command}' command.",
